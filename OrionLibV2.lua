...
function OrionLibV2:MakeWindow(Info)
    ...
    function Tabs:MakeTab(TabInfo)  
        ...
        function TabFunctions:AddDropdown(info)
            ...
            -- Dropdown title and description
            local dropdownText = Instance.new("TextLabel", container)
            dropdownText.Text = info.Name or "Dropdown"
            dropdownText.Size = UDim2.new(1, -60, 0, 20)
            ...
            local dropdownDescription = Instance.new("TextLabel", container)
            dropdownDescription.Text = info.Description or ""
            dropdownDescription.Size = UDim2.new(1, -60, 0, 15)
            ...
            dropdownList.Position = UDim2.new(1, -110, 0.5, 12)
            ...
            local function toggleDropdown()
                ...
                TweenService:Create(dropdownList, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
                    Size = UDim2.new(0, 100, 0, targetHeight),
            ...
            local function buildDropdownList()
                ...
                dropdownButton.Size = UDim2.new(0, math.min(maxTextWidth + 30, 200), 0, 24)
                dropdownButton.Position = UDim2.new(1, -(math.min(maxTextWidth + 40, 210)), 0.5, -12)
                dropdownList.Size = UDim2.new(0, math.min(maxTextWidth + 30, 200), 0, Dropdown.Opened and math.min(#Dropdown.Values * 30, 120) or 0)
                dropdownList.Position = UDim2.new(1, -(math.min(maxTextWidth + 40, 210)), 0.5, 12)
