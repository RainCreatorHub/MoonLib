-- RainLib v1.1.0: Biblioteca de UI completa com design inspirado no OrionLib
...
-- Função de arrastar (inspirada no OrionLib)
...
function RainLib:Window(options)
    ...
    local success, err = pcall(function()
        ...
        window.MinimizeBtn.Position = UDim2.new(1, -70, 0, 10)
...
function RainLib:Notify(options)
    ...
    local success, err = pcall(function()
        ...
        notification.Position = UDim2.new(1, 10, 0, (#RainLib.Notifications:GetChildren() - 1) * 90 + 10)
...
function RainLib:SetTheme(theme)
    ...
    local success, err = pcall(function()
        ...
        for _, window in pairs(RainLib.Windows) do
            ...
            window.MinimizeBtn.BackgroundColor3 = theme.Accent
...
function RainLib:Destroy()
    ...
    print("[RainLib] Biblioteca destruída!")
end
